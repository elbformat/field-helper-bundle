...
class ReadWriteContentTest extends KernelTestCase
{
    ...
    protected function createContentType(): ContentType
    {
        ...
        $this->addField($ctStruct, 'boolean', 'ibexa_boolean', 10);
        $this->addField($ctStruct, 'datetime', 'ibexa_datetime', 20);
        $this->addField($ctStruct, 'date', 'ibexa_date', 30);
        $this->addField($ctStruct, 'email', 'ibexa_email', 40);
        $this->addField($ctStruct, 'float', 'ibexa_float', 50);
        $this->addField($ctStruct, 'integer', 'ibexa_integer', 60);
        $this->addField($ctStruct, 'objectrelation', 'ibexa_object_relation', 80);
        $this->addField($ctStruct, 'objectrelationlist', 'ibexa_object_relation_list', 90);
        $this->addField($ctStruct, 'text', 'ibexa_text', 120);
        $this->addField($ctStruct, 'string', 'ibexa_string', 130);
        $this->addField($ctStruct, 'time', 'ibexa_time', 140);
        $this->addField($ctStruct, 'url', 'ibexa_url', 150);
